...
class InformationModelForProvider extends ChangeNotifier {
  ...
  // i place this i the data container as updated info. This shows in the
  //Profile page info screen
  late String newTitle;
  late String newEmail;
  late String newPassword;

  // This acts as a window to my list. I can see it but cant touch it.
  // this way I don't mistakenly assess the parameter list and will use my addInformation method
  //making it private means I cant access it in other pages but using a normal method defeats
  // purpose of making "parameterList" private since i'll be able to access the parameters in "parameterList"
  ...
  void addInformationToPasswordManagerInfo(
...
// update PasswordManagerInfo takes a string of the parameters of the model so it is able to easily
// place it in the right location of the data container. I wonder if there's an easier way.
  void updatePasswordManagerInfo(
    String title,
    String email,
    String password,
  ) {
...
// for the delete method to work, it accepts an argument of type PasswordManagerInfoModel.
  // this is so that it takes in the index of the current model iteration in use in the main page(the one the user has tapped on)
